...
public class CurveDemo extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        pane.getChildren().addAll(quadCurve, new Circle(40, 20, 6), new Text(40 + 5, 20 - 5, "Control point"));

        // Create a CubicCurve
        CubicCurve cubicCurve = new CubicCurve(200, 80, 240, 20, 350, 156, 450, 80);
        cubicCurve.setFill(Color.WHITE);
        cubicCurve.setStroke(Color.BLACK);
        pane.getChildren().addAll(cubicCurve, new Circle(240, 20, 6), new Text(240 + 5, 20 - 5, "Control point 1"),
                new Circle(350, 156, 6), new Text(350 + 5, 156 - 5, "Control point 2"));
