...
public class AddNewRowDemo extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        ObservableList<Country> data = FXCollections.observableArrayList(new Country("USA", "Washington DC", 280, true),
                new Country("Canada", "Ottawa", 32, true), new Country("United Kingdom", "London", 60, true),
                new Country("Germany", "Berlin", 83, true), new Country("France", "Paris", 60, true));
        ...
        TableColumn westernColumn = new TableColumn("Is Western Country?");
       westernColumn.setMinWidth(100);
       westernColumn.setCellValueFactory(new PropertyValueFactory<Country, Boolean>("western"));
        tableView.getColumns().addAll(countryColumn, capitalColumn, populationColumn, westernColumn);
        ...
        CheckBox chkWestern = new CheckBox("Is Western Country?");
        ...
        flowPane.getChildren().addAll(new Label("Country: "), tfCountry, new Label("Capital"), tfCapital,
                new Label("Population"), tfPopulation, chkWestern, btAddRow);
        btAddRow.setOnAction(e -> {
            data.add(new Country(tfCountry.getText(), tfCapital.getText(), Double.parseDouble(tfPopulation.getText()),
            chkWestern.isSelected()));
            tfCountry.clear();
            tfCapital.clear();
            tfPopulation.clear();
        });
    ...
    public static class Country {
        ...
        private final SimpleBooleanProperty western;

        private Country(String country, String capital, double population, boolean western) {
            this.country = new SimpleStringProperty(country);
            this.capital = new SimpleStringProperty(capital);
            this.population = new SimpleDoubleProperty(population);
            this.western = new SimpleBooleanProperty(western);
        }
